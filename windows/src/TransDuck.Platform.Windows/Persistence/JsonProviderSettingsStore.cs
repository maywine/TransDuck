...
public sealed class JsonProviderSettingsStore : IProviderSettingsStore, IDisposable
{
    ...
    /// <summary>Creates a store using the provider settings file resolved by Windows data paths.</summary>
    public JsonProviderSettingsStore(WindowsDataPaths paths)
