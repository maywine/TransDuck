...
/// <summary>
/// Defines the only persisted proxy settings version accepted by this client.
/// </summary>
public static class ProxySettingsMigration
{
    /// <summary>Gets the only proxy settings version accepted by this implementation.</summary>
    public const int CurrentVersion = 1;
}

/// <summary>
/// Selects the proxy policy used by translation-provider requests.
/// </summary>
...
/// <summary>
/// Stores the non-secret proxy policy used by translation-provider requests.
/// </summary>
public sealed record ProxySettings(
    [property: JsonRequired] int Version,
    [property: JsonRequired] ProxyMode Mode,
    Uri? CustomHttpProxyUri)
{
    /// <summary>Gets the proxy policy used when no persisted settings document exists.</summary>
    public static ProxySettings Default { get; } = new(
    ...
    {
        if (Version != ProxySettingsMigration.CurrentVersion)
        {
            throw new ContractValidationException(
                ContractValidationError.InvalidValue,
                "Proxy settings version is not supported.");
        }
    ...
    public override string ToString() =>
        $"ProxySettings(Version={Version}, Mode={Mode}, " +
