...
public sealed class JsonLinesHistoryStore : IQueryHistoryStore, IDisposable
{
    ...
    /// <summary>Creates a store using the platform-resolved history file.</summary>
    public JsonLinesHistoryStore(IApplicationDataPaths paths, TimeProvider? timeProvider = null)
